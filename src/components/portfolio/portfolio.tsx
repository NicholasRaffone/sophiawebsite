                ...
                <div className="grid md:grid-cols-2 gap-y-8">
                    <div className="flex justify-center items-center">
                        <div className="h-80 w-80 ">
                            <img src={portrait} alt="" className='h-72 w-auto mx-auto'/>
                            <p className='text-center text-white text-2xl mt-2'>Self-Portrait, 2021</p>
                        </div>
                    </div>
                    <div className="flex justify-center items-center">
                        <div className="h-80 w-80 ">
                            <img src={angel} alt="" className='h-72 w-auto mx-auto'/>
                            <p className='text-center text-white text-2xl mt-2'>Angel</p>
                        </div>
                    </div>
                    <div className="flex justify-center items-center">
                        <div className="h-80 w-80 ">
                            <img src={ink} alt="" className='h-72 w-auto mx-auto'/>
                            <p className='text-center text-white text-2xl mt-2'>Ink</p>
                        </div>
                    </div>
                    <div className="flex justify-center items-center">
                        <div className="h-80 w-80 ">
                            <img src={pastel} alt="" className='h-72 w-auto mx-auto'/>
                            <p className='text-center text-white text-2xl mt-2'>Pastel</p>
                        </div>
                    </div>
                    <div className="flex justify-center items-center">
                        <div className="h-80 w-80 ">
                            <img src={cpencil} alt="" className='h-72 w-auto mx-auto'/>
